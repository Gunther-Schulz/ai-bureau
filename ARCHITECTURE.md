...
| **3.5** | Per-primitive detail topics (4 primitive-cluster topics + 2 cross-cutting integrators) | ACTIVE — third primitive-cluster topic LOCKED (workflow-work-unit; two-Pattern-B topic-template-class anchor); 3 primitive-cluster + cross-cutting integrator topics remain (claim-defensibility primitive cluster + scope-model + axis-interactions cross-cutting integrators) |
...
| `arch/<topic-slug>.md` × 11 | Per-topic detail | ~500 each | Active (7 of 11 drafted: substrate / adapter / sparring / audit / specialist-skill / practitioner / workflow-work-unit) |
