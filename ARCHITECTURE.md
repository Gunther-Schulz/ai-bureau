...
| **3.5** | Per-primitive detail topics (4 primitive-cluster topics + 2 cross-cutting integrators) | ACTIVE — fourth primitive-cluster topic LOCKED (claim-defensibility; PRIMITIVE+DERIVED topic-template-class anchor); 2 cross-cutting integrator topics remain (scope-model + axis-interactions) |
...
| `arch/<topic-slug>.md` × 11 | Per-topic detail | ~500 each | Active (8 of 11 drafted: substrate / adapter / sparring / audit / specialist-skill / practitioner / workflow-work-unit / claim-defensibility) |
