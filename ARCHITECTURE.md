...
| **3.5** | Per-primitive detail topics (4 primitive-cluster topics + 2 cross-cutting integrators) | ACTIVE — fifth ARCH topic LOCKED (scope-model; first cross-cutting integrator topic-template-class anchor); 1 cross-cutting integrator topic remains (axis-interactions) |
...
| `arch/<topic-slug>.md` × 11 | Per-topic detail | ~500 each | Active (9 of 11 drafted: substrate / adapter / sparring / audit / specialist-skill / practitioner / workflow-work-unit / claim-defensibility / scope-model) |
