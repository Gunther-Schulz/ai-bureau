...
- ARCH Layer 3 per-protocol topics — per-protocol Surface specifications, per-implementation detail, selection mechanics per Pattern A topic-template (12 common-required + 7 conditional sections per `MAINTENANCE.md` Layer 3 Pattern A template): [arch/substrate.md](../arch/substrate.md) (Pattern A anchor; LOCKED), [arch/adapter.md](../arch/adapter.md) (Pattern A; LOCKED), `arch/quality-gate.md` (Pattern A; Phase 3.6 forthcoming); mechanism-class topic-template extension via [arch/sparring.md](../arch/sparring.md) + [arch/audit.md](../arch/audit.md) (Pattern D mechanism-class; LOCKED)
