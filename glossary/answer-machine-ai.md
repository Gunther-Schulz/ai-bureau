...
**Composes with**:
- [sparring (axis 2)](sparring.md) — state being degraded; answer-machine is the EXTRACTION-shape failure
- [category collapse](category-collapse.md) — general force; answer-machine is its axis-2 extraction-direction manifestation
- [practitioner](practitioner.md) — cognitive-state-bound agent; query patterns reveal the answer-machine category
- [intertwining (axis 1)](intertwining.md) — possible composition: practitioner intertwined-with-AI but using as answer-machine = workspace deeply integrated yet axis-2 collapsed
- [defensibility](defensibility.md) — answer-machine outputs typically fail defensibility's engaged-authorship condition (no sparring engagement → no engaged authorship → axis-3 failure cascade)
- [claim](claim.md) — claims produced via answer-machine extraction lack sparring rigor; less defensible per claim
- [oracle AI](oracle-ai.md) — sibling failure mode (declarative-direction shape vs extractive-direction shape)
- [validator AI](validator-ai.md) — sibling failure mode (affirmation-direction shape vs extractive-direction shape)
- [tacked-on AI](tacked-on-ai.md) — axis-1 parallel failure mode; both manifest category collapse on different axes
- [engaged authorship](engaged-authorship.md) — production-phase failure mode contrast; answer-machine extraction during production bypasses engaged-authorship's production-phase engagement (no sparring participation → no engaged authorship at production phase → defensibility's engaged-authorship condition fails per claim)
...
- Locked GLOSSARY entries: [sparring (axis 2)](sparring.md) (state degraded); [category collapse](category-collapse.md) (general force); [tacked-on AI](tacked-on-ai.md) (axis-1 parallel failure mode)
...
**See**:
- [sparring (axis 2)](sparring.md) (state being degraded)
- [category collapse](category-collapse.md) (general force; this is axis-2 manifestation)
- [oracle AI](oracle-ai.md) (sibling axis-2 failure mode — declarative direction)
- [validator AI](validator-ai.md) (sibling axis-2 failure mode — affirmation direction)
- [tacked-on AI](tacked-on-ai.md) (axis-1 parallel failure mode)
- [arch/axis-interactions.md](../arch/axis-interactions.md) — answer-machine-ai as axis-2 failure mode per §2.2 + §4.1 per-primitive axis-anchoring catalog (extraction-direction failure shape per Vivienne Ming research; three independent axis-2 failure shapes); axis-2 failure → cascades to axis-3 production-phase per CC-1 cross-axis failure cascade pattern §3.4 (production-phase sparring engagement bypassed → engaged-authorship Cond #1 production-phase fails); axis-2 collapse to "answer machine" per §4.3 category-collapse manifestation; per-axis observability hooks per §7 E2 (extraction-pattern signals); quality-gate Pattern A as architectural counter-mechanism per §4.3 LOCKED Phase 3.6 per [arch/quality-gate.md](../arch/quality-gate.md) (Phase 3.5 sixth + final ARCH topic LOCKED; second cross-cutting integrator extending scope-model anchor WITHOUT variation)
