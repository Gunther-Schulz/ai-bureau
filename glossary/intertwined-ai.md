...
**Composes with**:
- [intertwining (axis 1)](intertwining.md) — intertwined AI IS the success state of this axis
- [tacked-on AI](tacked-on-ai.md) — failure mode contrasted; same axis, opposite shape
- [co-worker](co-worker.md) — the relational frame intertwined AI realizes
- [category collapse](category-collapse.md) — the force that degrades intertwined → tacked-on regardless of architectural intent
- [sparring (axis 2)](sparring.md) — axis-2 activates WITHIN axis-1 intertwining; sparring fires within work-production, not as separate review step (VISION line 43 axis-interaction)
...
- Locked GLOSSARY entries: [intertwining (axis 1)](intertwining.md); [co-worker](co-worker.md)

**See**:
- [intertwining (axis 1)](intertwining.md) (the architectural commitment intertwined AI realizes)
...
- `arch/substrate.md` (Phase 3.4 locked — substrate Surface §B hooks + §F session/context realize cross-session axis-1 intertwining mechanisms); `arch/workflow-work-unit.md` (Phase 3.5 third primitive-cluster LOCKED — workflow IS what intertwined AI intertwines WITH; axis-1 PRIMARY anchor for workflow); [arch/axis-interactions.md](../arch/axis-interactions.md) — axis-1 success mode per §2.1 + §4.1 per-primitive axis-anchoring catalog (axis-1 PRIMARY); axis-2 activates WITHIN axis-1 intertwining per §3.1 (sparring fires within work-production not as separate review step); axis-1 FOUNDATIONAL substrate for axes 2+3 per §3.3 asymmetric composition (Phase 3.5 sixth + final ARCH topic LOCKED; second cross-cutting integrator extending scope-model anchor WITHOUT variation)
