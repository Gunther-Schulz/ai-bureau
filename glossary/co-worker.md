...
**Composes with**:
- [intertwining (axis 1)](intertwining.md) — co-worker IS the relational frame intertwining establishes
- [intertwined AI](intertwined-ai.md) — positive mode where co-worker frame is realized
- [tacked-on AI](tacked-on-ai.md) — failure mode where co-worker frame collapses to tool-frame
...
- Locked GLOSSARY entries: [intertwining (axis 1)](intertwining.md); [practitioner](practitioner.md); [intertwined AI](intertwined-ai.md)

**See**:
- [intertwining (axis 1)](intertwining.md) (which establishes co-worker frame)
