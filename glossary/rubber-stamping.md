...
**Composes with**:
- [engaged authorship](engaged-authorship.md) — success-mode contrast; rubber-stamping is engaged-authorship's attestation-phase failure mode (asymmetric: rubber-stamping is attestation-only failure; engaged authorship is two-phase success requiring production + attestation)
- [authorship preservation (axis 3)](authorship-preservation.md) — state being degraded; rubber-stamping is the SIGN-OFF-WITHOUT-ENGAGEMENT failure
- [category collapse](category-collapse.md) — general force; rubber-stamping is its axis-3 manifestation (engaged-author re-categorized as output-approver)
- [defensibility](defensibility.md) — directly fails defensibility's engaged-authorship condition (condition 1 of three structural conditions); axis-3 failure
- [claim](claim.md) — claims rubber-stamped lack engaged-authorship; per-claim defensibility fails when rubber-stamping occurred at finalization
- [practitioner](practitioner.md) — the cognitive-state-bound agent in whom the failure manifests at attestation moment
- [event](event.md) — attestation events can record sign-off without recording engagement; events insufficient evidence by themselves
- [tacked-on AI](tacked-on-ai.md) — axis-1 parallel failure mode (different axis; same general force)
- [answer-machine AI](answer-machine-ai.md) / [oracle AI](oracle-ai.md) / [validator AI](validator-ai.md) — axis-2 parallel failure modes (independent dimensions; can co-occur)
...
- Locked GLOSSARY entries: [authorship preservation (axis 3)](authorship-preservation.md) (state degraded); [defensibility](defensibility.md) (engaged-authorship condition that rubber-stamping fails); [category collapse](category-collapse.md) (general force); [tacked-on AI](tacked-on-ai.md) (axis-1 parallel); [answer-machine AI](answer-machine-ai.md) / [oracle AI](oracle-ai.md) / [validator AI](validator-ai.md) (axis-2 parallels)
...
**See**:
- [authorship preservation (axis 3)](authorship-preservation.md) (state being degraded)
- [defensibility](defensibility.md) (the test rubber-stamping fails — engaged-authorship condition)
...
- [arch/claim-defensibility.md](../arch/claim-defensibility.md) — rubber-stamping as axis-3 failure mode failing defensibility's Cond #1 engaged-authorship attestation-phase per per-claim attestation chain mechanics + per-claim attestation event mandatoriness per shape (Phase 3.5 fourth primitive-cluster ARCH topic LOCKED; PRIMITIVE+DERIVED topic-template-class anchor; `quality-gate` Pattern A protocol LOCKED Phase 3.6 per [arch/quality-gate.md](../arch/quality-gate.md) composes with axis-3 rubber-stamping signal at attestation moments per `arch/quality-gate.md` §2 capability category B per-axis signal ingestion)
- [arch/axis-interactions.md](../arch/axis-interactions.md) — rubber-stamping as axis-3 failure mode at attestation phase per §2.3 + §4.1 per-primitive axis-anchoring catalog; axis-3 attestation-phase failure INDEPENDENTLY possible regardless of axes 1+2 success per CC-1 cross-axis failure cascade pattern §3.4 (axis-3 collapse INDEPENDENT of axes 1+2 success at production phase; orthogonal); axis-3 collapse to "rubber-stamp signing" per §4.3 category-collapse manifestation; per-axis observability hooks per §7 E2 (per-claim attestation event timing / batch-attestation rapid-rate signals) (Phase 3.5 sixth + final ARCH topic LOCKED; second cross-cutting integrator extending scope-model anchor WITHOUT variation)
