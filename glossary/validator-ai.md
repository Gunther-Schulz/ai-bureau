...
**Composes with**:
- [sparring (axis 2)](sparring.md) — state being degraded; validator is the AFFIRMATION-shape failure
- [category collapse](category-collapse.md) — general force; validator is its axis-2 affirmation-direction manifestation
- [practitioner](practitioner.md) — cognitive-state-bound agent; query-pattern reveals the validator category
- [defensibility](defensibility.md) — validator outputs fail defensibility's engaged-authorship condition (sycophantic confirmation is not engagement); axis-3 cascade
- [claim](claim.md) — claims produced via validator confirmation lack the rigor sparring would have provided
- [answer-machine AI](answer-machine-ai.md) — sibling failure mode (extractive direction)
- [oracle AI](oracle-ai.md) — sibling failure mode (declarative direction)
...
- [engaged authorship](engaged-authorship.md) — production-phase failure mode contrast; validator-mode confirmation during production bypasses engaged-authorship's production-phase engagement (sycophantic confirmation is not sparring participation → no engaged authorship at production phase → claims fail defensibility)
