...
**Composes with**:
- [intertwining (axis 1)](intertwining.md) — primary state being degraded (intertwined → tacked-on collapse)
- [intertwined AI](intertwined-ai.md) — specific axis-1 mode that collapses
- [tacked-on AI](tacked-on-ai.md) — axis-1 collapse outcome
- [co-worker](co-worker.md) — relational frame that collapses (re-categorized to tool)
- [sparring (axis 2)](sparring.md) — axis-2 collapse target (sparring → answer-machine / oracle / validator)
- [authorship preservation (axis 3)](authorship-preservation.md) — axis-3 engaged-authorship state being degraded
- [engaged authorship](engaged-authorship.md) — axis-3 success mode that category collapse degrades; axis-3 manifestation = rubber-stamping (attestation-phase) and axis-2 manifestations = answer-machine/oracle/validator AI (production-phase) all bypass engaged-authorship's two-phase composite test
...
- Locked GLOSSARY entries: [intertwining (axis 1)](intertwining.md) (composes with category collapse); [tacked-on AI](tacked-on-ai.md) (axis-1 failure outcome); [co-worker](co-worker.md) (relational frame)
...
**See**:
- [intertwining (axis 1)](intertwining.md) (state being degraded, axis-1 primary)
- [tacked-on AI](tacked-on-ai.md) (axis-1 failure outcome)
