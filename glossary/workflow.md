...
- [category collapse](category-collapse.md) / [quality-gate](quality-gate.md) (GLOSSARY entry locked; full Phase 3.6 ARCH topic forthcoming) — workflow_instance execution is observability source for quality-gate's drift detection (e.g., practitioner approving phase transitions without engaging review content → axis-3 rubber-stamping signal)
