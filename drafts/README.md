...
- **Drafts can graduate**. When a draft matures (via additional sharpening rounds + user lock), it lifts to its proper home: STRATEGY.md (positioning) / VISION.md (stance) / GLOSSARY.md (vocabulary) / etc. At graduation, the draft is removed or marked GRADUATED-TO-X.
