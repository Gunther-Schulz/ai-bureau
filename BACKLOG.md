...
- **co-worker** [origin: TOC §7 + intertwining Composes-with] — relational claim about AI's mode of participation; conversational vocabulary
- **intertwined AI** [origin: TOC §7 + intertwining Composes-with] — positive axis-1 mode (the success state)
- **tacked-on AI** [origin: TOC §7 + intertwining Composes-with] — failure mode of axis 1 (the contrast / anti-pattern)
...
- **category collapse** [origin: TOC §8 + intertwining Composes-with] — biggest risk to axis 1; meta concept
