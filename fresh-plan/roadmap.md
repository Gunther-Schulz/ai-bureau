...
| 14 | Boot-procedure cluster supersedes entry | DONE (entry locked 2026-05-12 as D46; impl follow-through pending) | D46 locks D45 triad applied to boot path: 3 SUSPECT paths unified (steps 6/7/8 silent ValueError swallowing; manifest-actor seeding mid-cascade rollback; capability-only substrate-binding recovery semantics). Sets the structural template for D47-D51. Impl follow-through: ~30-50 lines in boot.py + 4-5 new test cases (separate commit). |
